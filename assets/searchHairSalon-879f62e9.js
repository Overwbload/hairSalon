import{g as c}from"./main-6296f0c4.js";const f=JSON.parse(localStorage.getItem("areaEnCh")),s=JSON.parse(localStorage.getItem("areaSearchPanelResult")),i=document.querySelector(".area-tags"),p=document.querySelector(".dropdown-search-category"),l=document.querySelector(".dropdown-search-area"),r=document.querySelector(".searchSalon");function n(t){return f[t]===void 0?"not found":f[t]}function u(){i.innerHTML="",p.innerHTML="",l.innerHTML="",r.innerHTML=""}function b(){let t="",a="";s.districts===void 0?a=`
          ...
          <li class="col-lg-4 mb-6 overflow-hidden">
            <a href="./salonInfo.html" class="position-relative">
              ...
              <h3 class="searchInfo d-flex gap-2 align-items-center py-2 px-4 position-absolute start-0 bg-black-60 bg-opacity-50 w-100">
                <img class="rounded-circle object-fit-cover" src="${c("/assets/images/searchSalonpage/salon-logo-01.png")}" alt="">
  ...
  `,r.innerHTML=a}function h(t){if(t==="allArea"){if(s.districts===void 0)return;l.querySelector("button:first-child span").textContent="所有區域",i.innerHTML=`
      <li class="fs-28 ls-tiny-5">#${n(s.cityName)}</li>
    `;let e="";s.districts.forEach(o=>{o.salons.forEach(d=>{e+=`
          <li class="col-lg-4 mb-6 overflow-hidden">
            <a href="./salonInfo.html" class="position-relative">
              <div class="position-absolute top-0 start-0 opacity-20 w-100 h-100 fullMask"></div>
              <img class="object-fit-cover w-100" src="${d.thumbnail}" alt="">
              <h3 class="searchInfo d-flex gap-2 align-items-center py-2 px-4 position-absolute start-0 bg-black-60 bg-opacity-50 w-100">
                <img class="rounded-circle object-fit-cover" src="${c("/assets/images/searchSalonpage/salon-logo-01.png")}" alt="">
                <p class="text-black-0 ls-tiny-5 font-noto-serif">${d.salonName}</p>
              </h3>
            </a>
          </li>
  ...
  `,s.districts.forEach(e=>{e.districtName===t&&e.salons.forEach(o=>{a+=`
        ...
        `})}),r.innerHTML=a}u();b();const g=l.querySelectorAll(".dropdown-menu button");g.forEach(t=>{t.addEventListener("click",a=>{h(t.getAttribute("data-search-district"))})});
